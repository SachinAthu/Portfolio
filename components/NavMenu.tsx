...
export default function NavMenu() {
  ...
  return (
    <nav
      ...
      data-lenis-prevent>
      <ul className="nav-menu-links hide-scrollbar | mx-auto h-full overflow-y-auto pt-20 lg:pt-28">
        {navLinksArr && (
          <>
            {navLinksArr.map((l) => (
              <li key={l.key} className="nav-menu-link | flex translate-y-10 items-center justify-center opacity-0">
                <button
                  type="button"
                  className="py-6 text-center text-5xl font-semibold text-d-text sm:text-7xl"
