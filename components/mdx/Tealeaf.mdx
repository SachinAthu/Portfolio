...
import SYSTEM_DIAGRAM from "@/public/static/works/tealeaf/tealeaf_system_diagram.png";
...
<ImageViewer
  src={SYSTEM_DIAGRAM}
  srcPath="/static/works/tealeaf/tealeaf_system_diagram.png"
  alt="Tealeaf system diagram"
  dialogId="tealeafSystemDiagram"
  dialogAriaLabel="View Tealeaf system diagram"
  caption="Tealeaf system diagram"
/>
