# Corporate Website Development for Voxitec
...
_System diagram showing:_

![System Diagram](/static/works/voxitec/voxitec_system_diagram.png)
...
- **Mobile-first responsive** - custom Tailwind breakpoints from `2xs` to `5xl`
...
- **Git-based collaboration** - Feature branches (`main`, `nextjs-16`, `case-study`) with 192+ commits over ~12 months
